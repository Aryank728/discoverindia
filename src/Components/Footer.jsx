    ...
    return (
        <footer className='bg-[#ce8a5c] py-8 px-3'>
            <div className='container mx-auto border-top flex flex-col lg:flex-row justify-between items-center'>
                ...
                <p className='text-white font-poppins font-bold text-center lg:text-center'>Discover India <br /><span className='text-gray-800'>Made with ♥️ by Aryan Kumar</span></p>
